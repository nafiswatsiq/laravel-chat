        ...
        <div class="w-fit z-50 absolute bottom-0 right-4 border" x-show="open">
            <div class="relative">
                <div class="absolute -top-7 p-1 bg-white rounded-sm border right-0 cursor-pointer flex">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="times" class="w-5 h-5 fill-slate-800 hover:bg-slate-200" x-on:click="open = ! open"><path d="M13.41,12l4.3-4.29a1,1,0,1,0-1.42-1.42L12,10.59,7.71,6.29A1,1,0,0,0,6.29,7.71L10.59,12l-4.3,4.29a1,1,0,0,0,0,1.42,1,1,0,0,0,1.42,0L12,13.41l4.29,4.3a1,1,0,0,0,1.42,0,1,1,0,0,0,0-1.42Z"></path></svg>
